...
class FabricanteVehiculoController extends Controller {
	...
	{
		//fabricante_id
		//serie (autoincrement) no se necesita
		//color
		//cilindraje
		//potencia
		//peso
	...
	public function update(Request $request, $idFabricante, $idVehiculo)
	{
		...
		if($metodo === 'PATCH')
		{
			...
			return response()->json(['mensaje' => 'No se modificó ningun vehículo'],200);
		}
	...
	public function destroy($idFabricante, $idVehiculo)
	{
		...
		if(!$vehiculo)
		{
			return response()->json(['mensaje' => 'No se encuentra este vehiculo asosicado a ese fabricante', 'codigo' => 404],404);
		}
